...
void ImGui::ShowDemoWindow(bool *p_open) {
    ...
    if (ImGui::CollapsingHeader("Help")) {
        ...
        ImGui::BulletText("The \"Tools\" menu above gives access to: About Box, Style Editor,\n"
                          "and Metrics/Debugger (context purpose Dear ImGui debugging tool).");
        ImGui::Separator();
...
static void ShowDemoWindowTables() {
    ...
    if (ImGui::TreeNode("Nested tables")) {
        ...
        if (ImGui::BeginTable("nested1", 2,
            ...
            ImGui::Text("A0 Cell 0");
            {
                ...
                if (ImGui::BeginTable("nested2", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_Resizable |
                                                    ImGuiTableFlags_Reorderable | ImGuiTableFlags_Hideable)) {
    ...
    if (ImGui::TreeNode("Advanced")) {
        ...
        if (ImGui::BeginTable("##table", 6, flags, outer_size_enabled ? outer_size_value : ImVec2(0, 0),
                              inner_width_to_use)) {
            // Declare columns
            // We use the "user_id" parameter of TableSetupColumn() to specify a user id that will be stored in the sort specifications.
            // This is so our sort function can identify a column given our own identifier. We could also identify them based on their index!
            ...
            ImGui::TableSetupColumn("Quantity", ImGuiTableColumnFlags_PreferSortDescending, 0.0f,
                                    MyItemColumnID_Quantity);
            ImGui::TableSetupColumn("Description", ImGuiTableColumnFlags_WidthStretch, 0.0f,
                                    MyItemColumnID_Description);
