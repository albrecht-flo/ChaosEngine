...
bool ImGui::Combo(const char *label, int *current_item, bool (*items_getter)(void *, int, const char **), void *data,
    ...
    // The old Combo() API exposed "popup_max_height_in_items". The new more context BeginCombo() API doesn't have/need it, but we emulate it here.
...
bool ImGui::InputTextEx(const char *label, const char *hint, char *buf, int buf_size, const ImVec2 &size_arg,
    ...
    if (is_multiline) {
        ...
        draw_window->DC.NavLayerActiveMaskNext |= (1
...
static void ImGui::TabBarLayout(ImGuiTabBar *tab_bar) {
    ...
    for (int tab_n = 0; tab_n < tab_bar->Tabs.Size; tab_n++) {
        ...
        int section_n = (tab->Flags & ImGuiTabItemFlags_Leading) ? 0 : (tab->Flags & ImGuiTabItemFlags_Trailing) ? 2
                                                                                                                 : 1;
